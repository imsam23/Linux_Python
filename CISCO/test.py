    ...
    def post(self, uri_ctx):
        ...
        for category in categories:
            ...
            if error_msg:
                ...
                continue
            category["category_type"] = str(category["category_type"]).lower().strip()
            ...
            category["category_name"] = str(category["category_name"]).strip()
            if category["category_name"] in current_names:
                CategoriesValidation.remove_unnecessary_params(category, category["category_type"])
                duplicate_names.append(category)
                continue

            if category["category_type"] == constants.CATEGORY_LOCAL:
            ...
            CategoriesValidation.remove_unnecessary_params(category, category["category_type"])
            current_names.append(category["category_name"])
